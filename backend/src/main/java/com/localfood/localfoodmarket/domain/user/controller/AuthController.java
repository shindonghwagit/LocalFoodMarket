...
public class AuthController {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ApiResponse<AuthResponseDto> completeOAuth2Register(
            @RequestBody @Valid OAuth2CompleteRequestDto request) {
        return ApiResponse.success(authService.completeOAuth2Register(request), "소셜 로그인 가입이 완료됐어요.");
    }
}
